...
export class AuthorizerWrapper {
    ...
    private createUserPool(){
        this.userPool = new UserPool(this.scope, 'MagnetoUserPool', {
            userPoolName: 'MagnetoUserPool',
    ...
    private addUserPoolClient(){
        this.userPoolClient = this.userPool.addClient('MagnetoUserPool-client', {
            userPoolClientName: 'MagnetoUserPool-client',
            authFlows: {
    ...
    private createAuthorizer(){
        this.authorizer = new CognitoUserPoolsAuthorizer(this.scope, 'MagnetoUserAuthorizer', {
            cognitoUserPools: [this.userPool],
            authorizerName: 'MagnetoUserAuthorizer',
